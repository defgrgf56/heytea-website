...
const messages = {
  'zh-CN': {
    ...
    profile: {
      ...
      orderNumber: '订单编号',
      total: '总计',
      passwordDesc: '定期修改密码可以提高账号安全性',
      cacheDesc: '清除缓存可以释放存储空间',
      logoutDesc: '退出登录后需要重新输入账号密码',
      change: '修改',
      clear: '清除'
    },
    productDetail: {
  ...
  'en': {
    ...
    profile: {
      ...
      total: 'Total',
      passwordDesc: 'Changing password regularly improves account security',
      cacheDesc: 'Clearing cache can free up storage space',
      logoutDesc: 'You need to re-enter your account and password after logout',
      change: 'Change',
      clear: 'Clear'
    },
    productDetail: {
