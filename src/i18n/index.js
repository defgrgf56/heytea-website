...
const messages = {
  'zh-CN': {
    ...
    payment: {
      ...
      itemsUnit: '件',
      amount: '支付金额',
      notice: '这是教学演示支付，点击"确认支付"即可完成模拟支付。订单将提交给商家，等待确认后开始制作。',
      confirmPay: '确认支付',
      paying: '支付中...',
      cancelBtn: '取消支付',
  ...
  'en': {
    ...
    payment: {
      ...
      itemsUnit: 'item(s)',
      amount: 'Amount',
      notice: 'This is a demo payment. Click "Confirm Payment" to complete the mock payment. Your order will be submitted to the merchant and await confirmation before preparation.',
